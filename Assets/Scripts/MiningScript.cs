...
public class MiningScript : MonoBehaviour
{
    ...
    private IEnumerator LoadSpritesAndThenChoose()
    {
    ...
    private void getOfflineIncome()
    {
        ...
        // Подсчёт количества каждой руды
    ...
    private void Start()
    {
        ...
        // Loading ores and chances
        OreChances = ShopPanelScripts.CalculateOreChances(sv.oreLevel);
        StartCoroutine(LoadSpritesAndThenChoose());
