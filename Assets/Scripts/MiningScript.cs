...
public class MiningScript : MonoBehaviour
{
    ...
    private void getOfflineIncome()
    {
        ...
        foreach (var kvp in OreChances)
        {
            ...
            var oreCount = (int)(chance * totalAttempts); // ����� ������������ Math.Floor/Math.Round �� �������
        ...
        foreach (var ore in OreNames.names)
        {
            ...
            Debug.Log($"Smelted {smeltedOres[ore]} ������ {ore} �� ����� ��������.");
            Debug.Log($"Mined {earnedOres[ore]} ������ {ore} �� ����� ��������.");
